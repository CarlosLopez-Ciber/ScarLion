...
```
      +------------------+
      |    Capa Núcleo   |  (Routers de alta velocidad)
      +------------------+
               |
               |
      +------------------+
      | Capa Distribución|  (Switches L3, políticas)
      +------------------+
               |
               |
      +------------------+
      |   Capa de Acceso |  (Switches L2, conexión de dispositivos)
      +------------------+
               |
      [Dispositivos Finales (PCs, Servidores, APs)]
```
...
```
  Modelo de 3 Capas            Modelo de Núcleo Colapsado
---------------------          ---------------------------
     [Núcleo]
          |                      [Núcleo / Distribución]
   [Distribución]                              |
